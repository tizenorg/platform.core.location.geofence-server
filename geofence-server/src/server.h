...
/**
* @brief	Scans for wifi
* @return	int
* @retval	NET_ERR_NONE if success
* @see	none
*/
int _geofence_scan_wifi();

/*int _geofence_add_smart_assistant_area(int area_index, int mode_state);
int _geofence_modify_smart_assistant_area(int area_index, int mode_state);
int _geofence_del_smart_assistant_area_list(TelSmartAssistantAreaList_t area_list);
int _geofence_collect_smart_assistant_info(unsigned int index, int start);
int _geofence_enable_smart_assistant();
int _geofence_disable_smart_assistant();*/
