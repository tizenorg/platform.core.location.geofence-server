...
#include "geofence_server_appman.h"
...
static void __Wifi_scan_request_callback(wifi_error_e error_code, void *user_data);
...
static void __add_left_fences(gpointer user_data)
{
	...
	int fence_id = 0;
	int count = 0;
	GeofenceItemData *tracking_item_data = NULL;
